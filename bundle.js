...
var app = (function () {
    ...
    function create_each_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(85:4) {#each list as task, idx}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(100:4) {#each playerList as player, idx}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file, 71, 0, 1415);
    			add_location(div0, file, 72, 0, 1442);
    			add_location(button0, file, 73, 0, 1479);
    			add_location(button1, file, 74, 0, 1519);
    			add_location(br, file, 75, 0, 1559);
    			add_location(hr0, file, 76, 0, 1564);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "placeholder", "Date");
    			attr_dev(input0, "name", "date");
    			add_location(input0, file, 79, 4, 1599);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "placeholder", "Task");
    			attr_dev(input1, "name", "task");
    			add_location(input1, file, 80, 4, 1676);
    			add_location(button2, file, 81, 4, 1753);
    			attr_dev(div1, "class", "listInputs");
    			add_location(div1, file, 78, 0, 1570);
    			add_location(ul0, file, 83, 0, 1821);
    			add_location(hr1, file, 92, 0, 1980);
    			attr_dev(input2, "type", "text");
    			attr_dev(input2, "placeholder", "playerID");
    			attr_dev(input2, "name", "playerID");
    			add_location(input2, file, 95, 4, 2015);
    			add_location(button3, file, 96, 4, 2105);
    			attr_dev(div2, "class", "statsinput");
    			add_location(div2, file, 94, 0, 1986);
    			add_location(ul1, file, 98, 0, 2174);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
